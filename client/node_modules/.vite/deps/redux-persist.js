import { i as combineReducers, o as createStore } from "./redux-BCAiQulL.js";
...
function _typeof$1(obj) {
	if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") _typeof$1 = function _typeof$2(obj$1) {
		return typeof obj$1;
	};
	else _typeof$1 = function _typeof$2(obj$1) {
...
function createPersistoid(config) {
	...
	var serialize;
	if (config.serialize === false) serialize = function serialize$1(x) {
		return x;
	};
	...
	var update = function update$1(state) {
...
function getStoredState(config) {
	...
	var deserialize;
	if (config.deserialize === false) deserialize = function deserialize$1(x) {
		return x;
	};
...
function persistReducer(config, baseReducer) {
	...
	var _purge = false;
	var _paused = true;
	var conditionalUpdate = function conditionalUpdate$1(state) {
	...
	return function(state, action) {
		...
		if (action.type === PERSIST) {
			var _sealed = false;
			var _rehydrate = function _rehydrate$1(payload, err) {
...
function _typeof(obj) {
	if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") _typeof = function _typeof$2(obj$1) {
		return typeof obj$1;
	};
	else _typeof = function _typeof$2(obj$1) {
		return obj$1 && typeof Symbol === "function" && obj$1.constructor === Symbol && obj$1 !== Symbol.prototype ? "symbol" : typeof obj$1;
	};
	return _typeof(obj);
}
...
var persistorReducer = function persistorReducer$1() {
...
function persistStore(store, options, cb) {
	...
	var register = function register$1(key) {
		_pStore.dispatch({
			type: REGISTER,
			key
		});
	};
	var rehydrate = function rehydrate$1(key, payload, err) {
		var rehydrateAction = {
			type: REHYDRATE,
			payload,
			err,
...
function createMigrate(migrations, config) {
	...
	return function(state, currentVersion) {
		...
		try {
			var migratedState = migrationKeys.reduce(function(state$1, versionKey) {
				if (debug) console.log("redux-persist: running migration for versionKey", versionKey);
				return migrations[versionKey](state$1);
			}, state);
